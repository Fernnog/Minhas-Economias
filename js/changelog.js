...
const changelogData = [
    { 
        ...
        date: "2026-04-22", 
        changes: [
            "Implementação de navegação temporal no Dashboard (visualização de meses futuros e passados)",
            "Adição de cards resumo de Orçamentos diretamente no painel inicial",
            "Nova funcionalidade para fixar (pin) orçamentos específicos no Dashboard",
            "Inclusão de card de totais consolidados (resumo geral) na aba de orçamentos"
        ] 
    },
    { 
        version: "1.0.3", 
