const BudgetModule = (function() {
    ...
    function init() {
        ...
        // exista apenas UM listener ativo
    ...
    function render() {
        ...
        // Lê pinnedBudgets do localStorage para refletir o estado atual
        ...
        // === NOVO: Renderizar Card de Totais Consolidados ===
        const totalCard = document.getElementById('budget-total-card');
        if (totalCard) {
            if (activeBudgets.length === 0) {
                totalCard.classList.add('hidden');
            } else {
                // Soma total gasto e total orçado em todas as categorias ativas
    ...
    function togglePin(category) {
        ...
        // Sincroniza a variável global no script.js sem recarregar a página
