const BudgetModule = (function() {
    ...
    function save() {
        ...
        const isUpdate = !!idField.value; // Capturado antes do reset para garantir precisão do Toast
        ...
        // Injeção da notificação de sucesso para orçamentos
    ...
    function remove(id) {
        if (confirm('Deseja excluir este orçamento?')) {
            ...
            // Injeção da notificação de sucesso para exclusão de orçamento
    ...
    function togglePin(category) {
        ...
        // Lógica de notificação para a fixação de painéis
